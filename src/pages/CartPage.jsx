...
export const CartPage = () => {
    ...
    const onClearCart = () => {
        if (window.confirm('Вы действительно хотите очистить коризну ?')) {
            dispatch(actions.clearCart())
        }
    }

    const onRemovePizzaHandler = id => dispatch(actions.removePizzaToCart(id))
    const onIncPizzaHandler = id => dispatch(actions.incrementCartItem(id))
    const onDecPizzaHandler = id => dispatch(actions.decrementCartItem(id))

    const onClickOrder = () => {
        alert('Ваш закаш находится в консоли')
        console.log(items)
    }
                ...
                <div className="content__items">
                    {addedPizzas.map(pizza => {
                        return <CartItem key={pizza.id}
                                         ...
                                         onRemovePizzaHandler={onRemovePizzaHandler}
                                         onIncPizzaHandler={onIncPizzaHandler}
                                         onDecPizzaHandler={onDecPizzaHandler} />
                    })}
                </div>
